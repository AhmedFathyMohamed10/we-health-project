...
final_columns = ['Code', 'Title_en', 'Chapter', 'H1', 'H2', 'H3', 'H4', 'H5'] + [col for col in test_icd.columns if col not in ['H1', 'H2', 'H3', 'H4', 'H5']]

# Save the updated test_icd.xlsx file with the desired columns
test_icd.to_excel("updated_test_icd_with_H5.xlsx", columns=final_columns, index=False)

print("H1, H2, H3, H4, and H5 columns have been successfully updated and saved to updated_test_icd_with_H5.xlsx, including Title_en and Chapter.")
